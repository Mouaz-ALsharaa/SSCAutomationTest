...
describe('AccountOperation', async() => {
   ...
   it('AccountList-', async() => {
        ...
        const Acc10= await UserMangment.AccountTree(10)
        Acc10.click()
        await browser.pause(500)
          const Acc101= await UserMangment.AccountTree(101)
          Acc101.click()
          await browser.pause(500)
          await UserMangment.AddAccountLocal.click()
          await browser.pause(500)
          await UserMangment.inptAccName.setValue('tellerLocal'+TellerNum)
           await browser.pause(500)
           const maincurr =await UserMangment.AddAccCheck(1)
            maincurr.click()
            await UserMangment.btnSave.click()
          await browser.pause(3000)

          await browser.keys([Key.Escape])

          const Acc11= await UserMangment.AccountTree(11)
          Acc11.click()
        await browser.pause(500)
          const Acc111= await UserMangment.AccountTree(111)
          Acc111.click()
          await browser.pause(500)
          await UserMangment.AddAccountForeign.click()
          await browser.pause(500)
          await UserMangment.inptAccName.setValue('tellerForeign'+TellerNum)
          for (let i=2; i<7; ++i ){
            const Foreigncurr =await UserMangment.AddAccCheck(i)
            await browser.pause(500)
            Foreigncurr.click()
          }
          await UserMangment.btnSave.click()
