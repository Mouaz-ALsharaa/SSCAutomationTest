...
it('tm<<مقبوضات كاملة', async() => {
        await browser.pause(2000)
        await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
        await Operation.AccountOperation(0,0,0,true)
    }),
it('مقبوضات على عملة ثانية', async() => {

      await Operation.AccountOperation(0,0,1,false)
  }),
...
describe('AccountOperation', async() => {
it('tm<<مدفوعات كاملة', async() => {
   await browser.pause(2000)
      //await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
      await Operation.AccountOperation(1,0,0,true)    
      // await agentDashboard.logout()
    })
   })

    describe('AccountOperation', async() => {
it('tm<<<ايداع بالحساب', async() => {
      //await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
      await Operation.AccountOperation(2,0,0,true)
  // await agentDashboard.logout()
  })
})

  describe('AccountOperation', async() => {
it('tm<<سحب من حساب', async() => {
   await browser.pause(2000)
   await Operation.AccountOperation(3,0,0,false)
   await browser.pause(1000)
    //await agentDashboard.logout()
}),
it('امر صرف', async() => {
   ...
   await browser.pause(2000)
   await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
   await Operation.AccountOperation(4,0,0,false)
    await agentDashboard.logout()
 })
})
 ...
 //-----------------------تســـــــوية----------------------------
 describe('AccountOperation', async() => {
 xit('tm<<<AccountOperation-adjustment-Debt-Read-Edit-lock-Unlock-print-Delete', async() => {
   await browser.pause(2000)
  // await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
   await Operation.adjustment(0,1,'debt')
   // await agentDashboard.logout()
 }),

 xit('AccountOperation-adjustment-credit-Read-Edit-lock-Unlock-print-Delete', async() => {
   await browser.pause(2000)
   //await LoginPage.loginUser(options.userAdmin,options.PasswordAdmin)
   await Operation.adjustment(0,1,'credt')
   await browser.pause(1000)
    await agentDashboard.logout()
 })
